  ...
  return (
      <div className="px-4 py-6 max-w-2xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-xl border p-5 space-y-6">
          <h2 className="text-sm font-semibold text-gray-700">Диапазон оценки</h2>
          {sliderField("Ширина диапазона (σ)", "range_sigma", 0.05, 0.35, 0.01, (v) => `±${Math.round(v * 100)}%`)}
        </div>

        <div className="bg-white rounded-xl border p-5 space-y-6">
          <h2 className="text-sm font-semibold text-gray-700">Множители уровней отделки</h2>
        ...
        <div className="bg-white rounded-xl border p-5 space-y-6">
          <h2 className="text-sm font-semibold text-gray-700">AI и пороги</h2>
        ...
        <div className="bg-white rounded-xl border p-5 space-y-4">
          <h2 className="text-sm font-semibold text-gray-700">Прочее</h2>
          <div className="flex items-center justify-between">
